...
console.log(strinhVar, numberBar, boolVar, arrayVar, objectVar)
...
// addEventListener(무슨일이 일어났을 때, 무슨 행동을 할지)
...
myImage.addEventListener("click", function(){
    ...
    if (src === "images/firefox-icon.png"){
        myImage.setAttribute("src", "images/nirvana.jpeg")
    } else {
